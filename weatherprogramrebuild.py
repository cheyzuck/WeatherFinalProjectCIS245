...
if user_decision == 'zip code':
    ...
    try:
        display_current_weather_info_zip(user_zip_code)
    except KeyError: ##someone accidentally enters anything else instead of zip code##
...
while True:
    ...
    if decision2 == 'q':
        quit()
    if decision2 != 'daily' or '5 day' or 'q':
        print("Invalid input. Please try again!")
